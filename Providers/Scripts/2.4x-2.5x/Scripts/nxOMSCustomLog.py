...
def Set_Marshall(Name, EnableCustomLogConfiguration = 0, CustomLogObjects = None):
    init_vars(CustomLogObjects)
    Set(EnableCustomLogConfiguration, CustomLogObjects)
    return [0]

def Test_Marshall(Name, EnableCustomLogConfiguration = 0, CustomLogObjects = None):
    init_vars(CustomLogObjects)
    return Test(EnableCustomLogConfiguration, CustomLogObjects)

def Get_Marshall(Name, EnableCustomLogConfiguration = 0, CustomLogObjects = None):
